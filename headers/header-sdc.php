...
<div id="post-featured-image">
	<div id="post-image-wrapper" style="background-image: url(<?php echo $sdc_custom->post_model->banner_src; ?>);"></div>
</div>
<?php endif; ?>
<?php if ( !is_front_page() ) : ?>
<nav id="pagebuilder-tertiary-nav" role="navigation">
	<ul>
		...
		?><li class="<?php if ( $post->ID == $nav_item->object_id ) echo ' selected'; ?>">
			<a class="" href="<?php echo $nav_item->url; ?>"><?php echo $nav_item->title; ?></a>
		</li><?php endforeach; ?>
	<?php else : ?>
		<li class="selected">
			<a class="" href="#"><?php echo get_the_title( $post->ID ); ?></a>
		</li>
	<?php endif; ?>
	</ul>
</nav>
